...
<%
	List<PagamentoBean> carte = (List<PagamentoBean>)request.getAttribute("carte");
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="text-content">
  ...
  <p class="description">stai visualizzando i metodi di pagamento di <strong class="name"><%=request.getParameter("utente") %></strong></p>
</div>
  <div class="credit">
  <%
      ...
      <div class="card">
        <div class="flip">
          ...
          <div class="back">
            ...
            <div class="terms">
              <p>Questa carta di credito è di proprietà di *iserire nome azineda*, Italia. In caso di ritrovamento, siete pregati di ristituirla.</p>
              <p>L'uso di questa carta è soggetto al contratto per carte di credito</p>
            </div>
          </div>
        </div>
      </div>
